...
total_work.plot <- total_work.plot + theme(panel.grid.minor = element_blank(),
  ...
  scale_y_continuous(lim = c(0, 15000000), breaks = seq(0, 20000000, 2000000), labels = function(x){paste0(x/1000000)}) 
...
clusters.table["dataset"] <- factor(clusters.table["dataset"], levels = c("Mocfe","Nekbone", "Multigrid"))
