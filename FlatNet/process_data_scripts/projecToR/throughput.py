...
for dataset in datasets:
    output_file = "../../../csv_data/flatnet/projector/{}/throughput.csv".format(dataset)
    ...
    for project in projects:
        for n in numberOfNodes:
            cluster_path = "{}/{}/{}/{}/{}/throughput.txt".format(input_dir, dataset, project, n, numberOfSimulations)
